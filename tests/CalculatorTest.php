...
use App\Rates\CalculatorSceneB;
use App\Rates\CalculatorSceneA;
use App\Rates\CalculatorSceneC;
...
class CalculatorTest extends TestCase
{
    ...
    protected function getCalculator(int $case): CalculatorContract
    {
        ...
        switch ($case) {
            case static::SCENARIO_A: return new CalculatorSceneA();
            case static::SCENARIO_B: return new CalculatorSceneB();
            case static::SCENARIO_C: return new CalculatorSceneC();
            default:
